...
export function MapPage() {
  ...
  const totalTripCost =
    selectedDestination.dailyBudget[budgetType] * parseInt(tripDuration);
    ...
    <div className="space-y-8 p-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Discover costs for places and plan your smart financial trips
        </p>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {tripDuration} days in {selectedDestination.name}
                </p>
              </div>
              <div className="text-right">
                ...
                <p className="text-sm text-primary/80">
                  ₹{selectedDestination.dailyBudget[budgetType]}/day
                </p>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-3 rounded-xl bg-primary/5 border border-primary/10">
                  ...
                  <div className="font-semibold text-foreground">
                    ₹{selectedDestination.dailyBudget.budget}/day
                  </div>
                </div>
                <div className="p-3 rounded-xl bg-primary/5 border border-primary/10">
                  <div className="text-xs text-muted-foreground mb-1">
                  ...
                  <div className="font-semibold text-foreground">
                    ₹{selectedDestination.dailyBudget.midRange}/day
                  </div>
                </div>
                <div className="p-3 rounded-xl bg-primary/5 border border-primary/10">
                  <div className="text-xs text-muted-foreground mb-1">
                  ...
                  <div className="font-semibold text-foreground">
                    ₹{selectedDestination.dailyBudget.luxury}/day
                  </div>
                </div>
              </div>
            </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-4 rounded-2xl glass-card border border-primary/10 hover:border-primary/30 transition-all duration-300">
              ...
              <p className="text-sm text-muted-foreground">
                ₹{selectedDestination.costs.coffee.min} - $
                {selectedDestination.costs.coffee.max}
              </p>
            </div>
            <div className="p-4 rounded-2xl glass-card border border-primary/10 hover:border-primary/30 transition-all duration-300">
              <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm text-muted-foreground">
                ₹{selectedDestination.costs.meal.min} - $
                {selectedDestination.costs.meal.max}
              </p>
            </div>
            <div className="p-4 rounded-2xl glass-card border border-primary/10 hover:border-primary/30 transition-all duration-300">
              <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm text-muted-foreground">
                ₹{selectedDestination.costs.hotel.min} - $
                {selectedDestination.costs.hotel.max}
              </p>
            </div>
            <div className="p-4 rounded-2xl glass-card border border-primary/10 hover:border-primary/30 transition-all duration-300">
              <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm text-muted-foreground">
                ₹{selectedDestination.costs.transport.min} - $
                {selectedDestination.costs.transport.max}
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="glass-card border-primary/20">
        ...
        <CardContent className="space-y-4">
          {filteredPlaces.map((place, index) => (
            <div
              key={index}
              className="flex items-center justify-between p-4 rounded-2xl glass-card border border-primary/10 hover:border-primary/30 transition-all duration-300"
            >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-xs text-muted-foreground flex items-center gap-1">
                      <Activity className="h-3 w-3" />⭐ {place.rating}
                    </span>
                  </div>
                </div>
              </div>
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-semibold text-primary">
              Smart Savings Intelligence
            </span>
          </div>
          <p className="text-sm text-foreground leading-relaxed mb-4">
            Based on your trip to {selectedDestination.name}, you could save
            $240 by choosing budget accommodations and eating at local places
            instead of tourist restaurants. Start saving now with a dedicated
            travel fund!
          </p>
          <p className="text-sm text-foreground leading-relaxed mb-4">
            You have spent a lot on food last month, try to save this month.
          </p>
          <div className="flex items-center gap-3">
            <Button
              size="sm"
