...
const newsItems = [
  {
    ...
    summary:
      "Fed officials signal potential 0.25% reduction following six consecutive months of declining inflation metrics",
    category: "Markets",
    time: "47m ago",
    image:
      "https://images.unsplash.com/photo-1748609278627-4b0e483b9b70?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBmaW5hbmNpYWwlMjBkYXNoYm9hcmQlMjBhbmFseXRpY3N8ZW58MXx8fHwxNzU4MzA4MDA1fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    likes: 1247,
    comments: 89,
    source: "Reuters",
    trending: true,
  ...
  },
  {
    ...
    summary:
      "Major banks report 300% increase in crypto service requests, Ethereum follows with 8% gains",
    category: "Crypto",
    time: "1h 23m ago",
    image:
      "https://images.unsplash.com/photo-1744473755637-e09f0c2fab41?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjcnlwdG9jdXJyZW5jeSUyMG1hcmtldCUyMHRyYWRpbmclMjBjaGFydHN8ZW58MXx8fHwxNzU4MzA4MDEyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    likes: 892,
    comments: 124,
    source: "CoinDesk",
    trending: true,
  ...
  },
  {
    ...
    summary:
      "Study reveals algorithmic trading strategies outperform traditional portfolio management",
    category: "Technology",
    time: "2h 15m ago",
    image:
      "https://images.unsplash.com/photo-1613442301287-4fa478efd9ca?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbnZlc3RtZW50JTIwcG9ydGZvbGlvJTIwc21hcnRwaG9uZSUyMGFwcHxlbnwxfHx8fDE3NTgzMDgwMTV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    likes: 567,
    comments: 76,
    source: "TechCrunch",
    trending: false,
  ...
  },
  {
    ...
    summary:
      "FTSE 100 gains 2.1% as Brexit trade negotiations show promising progress",
    category: "Global",
    time: "3h 42m ago",
    image:
      "https://images.unsplash.com/photo-1565688527174-775059ac429c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBidXNpbmVzcyUyMG1lZXRpbmclMjBmaW5hbmNlfGVufDF8fHx8MTc1ODI3NjI2OHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    likes: 334,
    comments: 41,
...
const communityPosts = [
  {
    ...
    badge: "Premium",
    content:
      "Just crossed $50K in my emergency fund using Fiinora's auto-save feature! The 1% optimization suggestions added an extra $200/month. This app literally pays for itself.",
    image:
      "https://images.unsplash.com/photo-1657049671938-3e5988228df3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmaW5hbmNpYWwlMjBzdWNjZXNzJTIwY2VsZWJyYXRpb24lMjBtb25leXxlbnwxfHx8fDE3NTgzNDYzMTV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    time: "32m ago",
    likes: 127,
    replies: 18,
  ...
  },
  {
    ...
    badge: "Investor Pro",
    content:
      "AI portfolio rebalancing just saved me from a 4% loss during yesterday's market dip. The risk adjustment algorithm is incredibly sophisticated - moved 15% to bonds automatically.",
    image:
      "https://images.unsplash.com/photo-1640451859877-1374a1155215?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbnZlc3RtZW50JTIwcG9ydGZvbGlvJTIwZGFzaGJvYXJkfGVufDF8fHx8MTc1ODI1MDE1NXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    time: "1h 15m ago",
    likes: 89,
    replies: 23,
  ...
  },
  {
    ...
    content:
      "I recommend Fiinora to all my clients now. The debt avalanche calculator helped one client save $12K in interest payments. Professional-grade analytics in a consumer app.",
    time: "2h 45m ago",
    likes: 156,
    replies: 31,
  ...
  },
  {
    ...
    badge: "Explorer",
    content:
      "Map cost predictions were 97% accurate for my Tokyo trip! Budgeted $3,200, spent $3,156. Even predicted the exact subway costs. Mind = blown 🤯",
    image:
      "https://images.unsplash.com/photo-1625241310933-640978bb5176?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0cmF2ZWwlMjBidWRnZXQlMjBwbGFubmluZyUyMHZhY2F0aW9ufGVufDF8fHx8MTc1ODM0NjMyMnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    time: "4h 12m ago",
    likes: 73,
    replies: 12,
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Your wealth grew by{" "}
            <span className="text-primary font-medium">₹1,247</span> this week
          </p>
        </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 rounded-xl bg-gradient-to-br from-primary/10 to-blue-500/10 border border-primary/20 hover:border-primary/40 transition-all duration-300">
              ...
              <p className="text-xl font-bold text-foreground">₹6,849.09</p>
            ...
            <div className="text-center p-4 rounded-xl bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20 hover:border-amber-500/40 transition-all duration-300">
              ...
              <p className="text-xl font-bold text-foreground">₹81,19,526.39</p>
              <div className="flex items-center justify-center gap-1 mt-1">
            ...
            <div className="text-center p-4 rounded-xl bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20 hover:border-green-500/40 transition-all duration-300">
              ...
              <p className="text-xl font-bold text-foreground">₹23,365.69</p>
              <div className="flex items-center justify-center gap-1 mt-1">
                <TrendingUp className="h-3 w-3 text-green-500" />
      ...
      <Card className="glass-card border-primary/20">
        ...
        <CardContent className="space-y-4">
          {newsItems.map((item) => (
            <div
              key={item.id}
              className="flex gap-4 p-4 rounded-2xl glass-card border border-primary/10 hover:border-primary/30 transition-all duration-300 cursor-pointer group"
            >
      ...
      <Card className="glass-card border-primary/20">
        ...
        <CardContent className="space-y-4">
          {communityPosts.map((post) => (
            <div
              key={post.id}
              className="p-4 rounded-2xl glass-card border border-primary/10 hover:border-primary/30 transition-all duration-300 cursor-pointer group"
            >
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <Badge
                      ...
                      className={`text-xs ${
                        post.badge === "Premium"
                          ? "bg-amber-500/10 text-amber-500 border-amber-500/20"
                          : post.badge === "Investor Pro"
                          ? "bg-blue-500/10 text-blue-500 border-blue-500/20"
                          : post.badge === "Financial Advisor"
                          ? "bg-green-500/10 text-green-500 border-green-500/20"
                  ...
                  {post.achievements && post.achievements.length > 0 && (
                    <div className="flex items-center gap-1 mb-2">
                      {post.achievements.slice(0, 2).map((achievement, idx) => (
                        <div
                          key={idx}
                          className="px-2 py-0.5 rounded-full bg-primary/5 border border-primary/10"
                        >
                          <span className="text-xs text-primary font-medium">
                            {achievement}
                          </span>
              ...
              <p className="text-sm mb-4 text-foreground leading-relaxed group-hover:text-foreground/90 transition-colors">
                {post.content}
              </p>
              ...
              {post.tags && post.tags.length > 0 && (
                <div className="flex items-center gap-2 mb-3">
                  {post.tags.map((tag, idx) => (
                    <span
                      key={idx}
                      className="px-2 py-1 rounded-full bg-primary/5 border border-primary/10 text-xs text-primary"
                    >
                      #{tag}
                    </span>
                  ))}
          ...
          {!showCreatePost ? (
            <div className="p-4 rounded-2xl glass-card border border-primary/10 text-center">
              <p className="text-sm text-muted-foreground mb-2">
                Share your financial wins with the community
              </p>
              <Button
                size="sm"
                className="bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20"
