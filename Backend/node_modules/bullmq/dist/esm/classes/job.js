...
export class Job {
    ...
    update(data) {
        this.data = data;
        return Scripts.updateData(this.queue, this, data);
    }
    /**
    ...
    async moveToFailed(err, token, fetchNext = false) {
        ...
        if (this.attemptsMade < this.opts.attempts &&
            ...
            if (delay === -1) {
                ...
                const args = Scripts.moveToDelayedArgs(queue, this.id, Date.now() + delay, token);
        ...
        if (moveToFailed) {
            const args = Scripts.moveToFailedArgs(queue, this, message, this.opts.removeOnFail, token, fetchNext);
