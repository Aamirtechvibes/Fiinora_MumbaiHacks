...
class Queue extends queue_getters_1.QueueGetters {
    constructor(name, opts, Connection) {
        ...
        this.limiter = (0, lodash_1.get)(opts, 'limiter');
        this.waitUntilReady()
            .then(client => {
            if (!this.closing) {
    ...
    async add(name, data, opts) {
        if (opts && opts.repeat) {
            ...
            const jobId = (0, utils_1.jobIdForGroup)(opts, data, { limiter: this.limiter });
    ...
    addBulk(jobs) {
        return job_1.Job.createBulk(this, jobs.map(job => ({
            name: job.name,
            data: job.data,
            opts: Object.assign(Object.assign(Object.assign({}, this.jobsOpts), job.opts), { jobId: (0, utils_1.jobIdForGroup)(job.opts, job.data, { limiter: this.limiter }) }),
        })));
    }
    /**
