...
class Job {
    ...
    update(data) {
        this.data = data;
        return scripts_1.Scripts.updateData(this.queue, this, data);
    }
    /**
    ...
    async moveToFailed(err, token, fetchNext = false) {
        ...
        if (this.attemptsMade < this.opts.attempts &&
            ...
            if (delay === -1) {
                ...
                const args = scripts_1.Scripts.moveToDelayedArgs(queue, this.id, Date.now() + delay, token);
    ...
    moveToDelayed(timestamp, token) {
        return scripts_1.Scripts.moveToDelayed(this.queue, this.id, timestamp, token);
    }
    /**
