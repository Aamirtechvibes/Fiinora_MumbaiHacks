...
- Commit and push this README (and other uncommitted files) to `https://github.com/Aamirtechvibes/Fiinora_MumbaiHacks.git`.
- Expand the README with per-project setup and run instructions.
- Add a `LICENSE` and CI workflows.

Tell me which you'd like, or I can proceed to commit & push now.
