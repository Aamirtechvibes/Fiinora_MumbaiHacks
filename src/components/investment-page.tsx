    ...
    <div className="space-y-8 p-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          AI-powered wealth generation and portfolio optimization
        </p>
      </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span
                  className={`text-sm font-medium ${
                    totalGainLoss >= 0 ? "text-primary" : "text-red-500"
                  }`}
                >
                  {totalReturn}% today
                </span>
      ...
      <Card className="glass-card border-primary/20">
        ...
        <CardContent className="space-y-6">
          {aiRecommendations.map((rec, index) => (
            <div
              key={index}
              className="p-4 rounded-2xl glass-card border border-primary/10 hover:border-primary/30 transition-all duration-300"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              {portfolioAllocation.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-3 rounded-xl glass-card border border-primary/10"
                >
                  <div className="flex items-center gap-3">
                    <div
        ...
        <CardContent className="space-y-4">
          <div className="p-4 rounded-2xl bg-gradient-to-br from-primary/5 to-blue-500/5 border border-primary/20">
            ...
            <p className="text-sm text-foreground leading-relaxed">
              Current market conditions favor technology stocks. AI predicts a
              15% upside potential for your portfolio over the next 6 months.
            </p>
          </div>
          <div className="p-4 rounded-2xl bg-gradient-to-br from-yellow-500/5 to-orange-500/5 border border-yellow-500/20">
            ...
            <p className="text-sm text-foreground leading-relaxed">
              Your portfolio is heavily weighted in technology. Consider
              diversifying into other sectors to reduce risk.
            </p>
          </div>
        </CardContent>
      </Card>
